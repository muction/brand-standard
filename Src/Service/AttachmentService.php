...
use Brand\Standard\Entity\AttachmentEntity;
...
class AttachmentService extends ServiceService
{
    ...
    public function upload(  Request $request , $client, $filePostName ='uploader')
    {
        ...
        $dataType =$request->input('data_type', 0 ) ;
     ...
     * @return array
     */
    protected function attachmentStorageStruck( $dataId ,$dataType, $originalName, $fileSize,  $saveFilePath , $type, $summary, $client , $newSaveFileName= null ){
